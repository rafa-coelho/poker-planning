...
class PrismaService {
  ...
  static async persistVote(sessionId, userId, cardValue) {
    const prisma = this.getInstance()
  ...
  static async clearVotes(sessionId) {
    const prisma = this.getInstance()
  ...
  static async updateCurrentTicket(sessionId, ticketId) {
    const prisma = this.getInstance()
  ...
  static async markParticipantInactive(sessionId, userId) {
    const prisma = this.getInstance()
